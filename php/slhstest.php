...
if ($result->num_rows > 0) {
	...
	echo "<form action='results.php' method='post' id='quiz'>";
	$count = 1;
    while($row = $result->fetch_assoc()) {
        echo "<h3>" . $count .  ". " . $row["question"] ."</h3>";
		echo "<div>";
		echo "<input type='radio' name='" . $count . "' value='a'>" . $row["choiceA"];
		echo "</div>";
		echo "<div>";
		echo "<input type='radio' name='" . $count . "' value='b'>" . $row["choiceB"];
		echo "</div>";
		echo "<div>";
		echo "<input type='radio' name='" . $count . "' value='c'>" . $row["choiceC"];
		echo "</div>";
		echo "<div>";
		echo "<input type='radio' name='" . $count . "' value='d'>" . $row["choiceD"];	
		echo "</div>";
		$count++;
    }
