...
<html class=" js canvas canvastext geolocation crosswindowmessaging websqldatabase indexeddb hashchange historymanagement draganddrop websockets rgba hsla multiplebgs backgroundsize borderimage borderradius boxshadow opacity cssanimations csscolumns cssgradients cssreflections csstransforms csstransforms3d csstransitions  video audio localstorage sessionstorage webworkers applicationcache svg smil svgclippaths   fontface"><!-- InstanceBegin template="/Templates/masterpage.dwt.php" codeOutsideHTMLIsLocked="false" --><head><meta http-equiv="Content-Type" content="text/html; charset=windows-1252">
    ...
    <link href="./SLHS - Health and Human Sciences_files/jquery-ui.css" rel="stylesheet" type="text/css"> 
    <script src="./SLHS - Health and Human Sciences_files/jquery.min.js"></script> 
    <script src="./SLHS - Health and Human Sciences_files/jquery-ui.min.js"></script>
    
    <!-- Updated menus script that uses jQuery instead of prototype --> 
    <script src="./SLHS - Health and Human Sciences_files/menus2.js" type="text/javascript"></script> 
    <!-- Slider Configurations - VERY IMPORTANT -->

    <link href="./SLHS - Health and Human Sciences_files/DDSlider.css" rel="stylesheet" type="text/css">
    <!-- jQuery framework -->
...
<body class="landing-page">
    ...
    <div id="background-strip" style="height:393px;"></div>
    ...
    <div id="page-container">
      ...
      <div id="header-container">
        ...
        <div id="purdue-signature-container"> 
          <a href="https://www.purdue.edu/"><img src="./PU_signature_white_bg_215x80.png" alt="Purdue signature" width="202" height="75" border="0" id="purdue-signature"></a>
        </div> 
...
<li><a href="SIM_Landing_Page.php">Home Page</a>
</li>
<li class="first"><a href="SIM_FAQ_Page.html">FAQ</a>
</li>
<li><a href="index.html">Simulations</a>
</li>
</ul>
</div>
</div>

     <!--Copy till here for each webpage -->
     
      
      
      <div id="inner-page-container" class="round-bottom10 shadow10">
        ...
        <div id="main-content-container" class="float-group">
        
          <div id="minimum-height-pad">&nbsp;</div>
          
          
            <!-- START CONTENT SECTION --><!-- InstanceBeginEditable name="Main Content" -->
            <div class="content-container">
              <h1>Welcome</h1>
              <p>The Peabody Picture Vocabulary Test, the 2007 edition of which is known as the PPVT-IV, is an untimed test of receptive vocabulary for Standard American English and is intended to provide a quick estimate of verbal ability and scholastic aptitude. It was first developed in 1959 by special education specialists Lloyd M. Dunn and Leota M. Dunn. This website provides a tool for students to learn about how the test is administered and provide a basic overview of the test.</p>
            </div>
            <div class="wrapper">
                <form method="post" action="User_form.php">
                    <input type="submit" class="button" value="New User Registration">
                </form>
            </div>
            <!-- InstanceEndEditable --><!-- END CONTENT SECTION --><!-- InstanceBeginEditable name="News" -->
